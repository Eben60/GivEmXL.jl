...
"""
    save_plots(overview, subsets_results, résumé, rslt_dir, paramsets) → nothing
...
- `paramsets`::Vector{NamedTuple}: may contain field `plotformat`

Function `save_plots` is public, not exported.
"""
